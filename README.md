...
- Chose median over mean to reduce the impact of extreme outliers
...
## 📊 Dashboard preview
<!-- After uploading your screenshot, replace the filename below with your image's name -->
![Power BI dashboard](dashboard.png)

## 💡 Key finding
> _[Write your actual conclusion here — e.g. "Location was the stronger driver of price overall, but room type dominated within the city centre."]_

## 🗣️ Defense
I presented and defended every analytical decision — granularity, median vs. mean, star schema design, and outlier handling — in front of an evaluation panel.
